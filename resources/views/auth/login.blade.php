        ...
        <div class="max-w-4xl w-full flex flex-col md:flex-row bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="md:w-1/2 bg-indigo-600 p-8 text-white">
                <div class="max-w-md mx-auto">
                    <h1 class="text-4xl font-bold mb-4">Welcome to Library Management System</h1>
                    <p class="text-indigo-100 mb-6">
                        A modern solution for managing your library's resources, books, and borrowing system.
                    </p>
                    <div class="space-y-4">
