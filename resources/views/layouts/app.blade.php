                ...
                <div class="flex justify-between h-16">
                    <div class="flex">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <a href="{{ route('borrowing-rules') }}" class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-white hover:border-gray-300 dark:hover:border-gray-600 focus:outline-none focus:text-gray-700 dark:focus:text-white focus:border-gray-300 dark:focus:border-gray-600 transition duration-150 ease-in-out">
                                Borrowing Rules
                            </a>
                            @if(auth()->check() && auth()->user()->role === 'admin')
                                ...
                                <a href="{{ route('announcements.index') }}" class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-sm font-medium leading-5 text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:hover:text-white hover:border-gray-300 dark:hover:border-gray-600 focus:outline-none focus:text-gray-700 dark:focus:text-white focus:border-gray-300 dark:focus:border-gray-600 transition duration-150 ease-in-out">
                                    Announcements
                                </a>
                            @endif
                        </div>
                    ...
                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                        <div class="ml-3 relative">
                            <div class="flex items-center space-x-4">
                                ...
                                <x-notifications :notifications="auth()->user()->notifications()->orderBy('created_at', 'desc')->take(10)->get()" />
